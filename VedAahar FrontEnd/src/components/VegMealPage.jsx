...
const VegMealPage = () => {
  ...
  useEffect(() => {
    if (!alertShown.current) {
      //alert("Please wait... Generating your Veg Meal Plan 🌱");
  ...
  useEffect(() => {
    ...
    console.log("Location:", lat, lon);
        ...
        console.log(email, prakriti, days);
  ...
  return (
    <div style={styles.page}>
      ...
      <h1 style={styles.title}>🌱 Veg Meal Plan</h1>
      <p style={styles.subtitle}>Healthy Ayurvedic vegetarian meals</p>
...
const styles = {
  page: {
    ...
    minHeight: "100vh",
    background:
      "linear-gradient(-45deg, #e8f5e9, #c8e6c9, #a5d6a7, #dcedc8)",
